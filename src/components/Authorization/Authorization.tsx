...
import { AuthorizationI, FormType, FormTypes } from './Authorization.D';
...
const Authorization = ({ signin, signup, isAuthorizate }: AuthorizationI) => {
  const [open, setOpen] = useState<boolean>(true);
  const [formType, setFormType] = useState<FormType>(FormType.signin);
  const [errors, setErrors] = useState<UserFieldError[]>([]);
